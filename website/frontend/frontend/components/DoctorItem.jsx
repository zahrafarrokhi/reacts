...
const DoctorItem = (props) => {
  ...
  return ( 
    ...
    className="flex relative cursor-pointer items-center flex-[1_1_100%] md:flex-[0_0_48%] m-2 p-5 border border-solid border-backgroundGray rounded-lg"
  >
    <div className="img">
      <img
        className="w-[7em] h-full"
        src="Doctors.svg"
        alt={doctor.name}
      />
    </div>
    <div className="flex flex-col w-full mr-5">
      ...
      <div className="hidden md:flex flex-wrap justify-end items-center">
        ...
        <Button
          variant="contained"
          className="py-2 w-[12em] mr-3 my-1"
        >
          درخواست ویزیت آنلاین
        </Button>
        <DynamicModal title="تراکنش ها" open={openModal} handleClose={() => setOpenModal(false)}>
          <DoctorProfile doctor={doctor} />ll
        </DynamicModal>
      </div>
    </div>
  </div>
